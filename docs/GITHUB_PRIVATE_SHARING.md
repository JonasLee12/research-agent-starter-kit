...
- External review is optional and advisory. Users without Claude Code can use `scripts/build_external_review_bundle.py`; Claude Code remains one optional privacy-gated runner when enabled.
